...
# Применим 2D SSA
ssa_2d <- ssa(t(Y_matrix), kind = "2d-ssa", L = c(30, 3))  # размер окна можно настроить
...
# Преобразуем Y_matrix (grid_n x N) в формат изображения
# Применим 2D SSA
ssa_2d <- ssa(t(Y_matrix), kind = "mssa", L = L)  # размер окна можно настроить
...
cat("RMSE для MSSA относительно истинного сигнала:", RMSE_2DSSA, "\n")
